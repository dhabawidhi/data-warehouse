...
namespace DW_IPB.Models
{
    ...
    public partial class DBPKLG62016Entities3 : DbContext
    {
        public DBPKLG62016Entities3()
            : base("name=DBPKLG62016Entities3")
        {
        }
        ...
        public virtual DbSet<WaktuMagisterDoktorDiploma> WaktuMagisterDoktorDiplomas { get; set; }
        ...
        public virtual DbSet<SarjanaLulusan> SarjanaLulusans { get; set; }
